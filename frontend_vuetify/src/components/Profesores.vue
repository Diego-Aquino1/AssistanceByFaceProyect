...
<v-app>
  ...
  <v-container fill-height>
        ...
        <v-layout row wrap align>
          <v-card
          height="500" text-h4 class="mx-auto my-12 text-center" width="400" outlined elevation="20">
          <v-form
            ref="form"
            v-model="valid"
            lazy-validation
...
export default{    
    ...
    methods:{
        addTask(){ 
            axios.post(this.postURL + '/task/add_teacher', this.newTask, this.config_request)
                .then(res => {                                         
        ...
        deleteTask(task){                      
            axios.post(this.postURL + '/task/delete_teacher', {CUI: task.CUI}, this.config_request)
                .then((res) => {                      
    ...
    created(){ 
        axios.post(this.postURL + '/task/get_teachers')
